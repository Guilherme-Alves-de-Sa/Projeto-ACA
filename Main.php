...
foreach ($entitiesInfo as $entity){
    ...
    foreach($entity as $page){
        ...
        $pageInfo = $cURL->pageInfoExtraction($pageHtml);
        ...
        if(strpos($page,"/tv/") !== false){
            file_put_contents("website/tv-shows.txt", $title.PHP_EOL.$score.PHP_EOL, FILE_APPEND);
        }
        elseif (strpos($page,"/movie/") !== false ){
            file_put_contents("website/movies.txt", $title.PHP_EOL.$score.PHP_EOL, FILE_APPEND);
        }
        elseif (strpos($page,"/music/")!== false){
            file_put_contents("website/music.txt", $title.PHP_EOL.$score.PHP_EOL, FILE_APPEND);
        }
        elseif (strpos($page,"/game/")!== false){
            file_put_contents("website/games.txt", $title.PHP_EOL.$score.PHP_EOL, FILE_APPEND);
        }
    }
}
